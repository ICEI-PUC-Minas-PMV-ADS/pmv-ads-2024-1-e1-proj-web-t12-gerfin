...
// modal dica: abrir e fechar modal
var abrir = document.getElementById("Botao");
var abrir2 = document.getElementById("Botao2");
var abrir3 = document.getElementById("Botao3");
var abrir4 = document.getElementById("Botao4");


var fechar = document.getElementById("Fecha");
var fechar2 = document.getElementById("Fecha2");
var fechar3 = document.getElementById("Fecha3");
var fechar4 = document.getElementById("Fecha4");


var ExibirModal = document.getElementById("modalOpen");
var ExibirModal2 = document.getElementById("modalOpen2");
var ExibirModal3 = document.getElementById("modalOpen3");
var ExibirModal4 = document.getElementById("modalOpen4");
...
abrir.onclick = function() {
  ExibirModal.style.display = "block";
  fade.style.display = "block";
}
abrir2.onclick = function() {
  ExibirModal2.style.display = "block";
  fade2.style.display = "block";
}
abrir3.onclick = function() {
  ExibirModal3.style.display = "block";
  fade3.style.display = "block";
}
abrir4.onclick = function() {
  ExibirModal4.style.display = "block";
  fade4.style.display = "block";
}


fechar.onclick = function() {
  ExibirModal.style.display = "none";
  fade.style.display = "none";
}
fechar2.onclick = function() {
  ExibirModal2.style.display = "none";
  fade2.style.display = "none";
}
fechar3.onclick = function() {
  ExibirModal3.style.display = "none";
  fade3.style.display = "none";
}
fechar4.onclick = function() {
  ExibirModal4.style.display = "none";
  fade4.style.display = "none";
}


acessarModal2.onclick = function() {
  ExibirModal2.style.display = "block";
    fade2.style.display = "block";
}
acessarModal3.onclick = function() {
  ExibirModal3.style.display = "block";
    fade3.style.display = "block";
}
acessarModal4.onclick = function() {
  ExibirModal4.style.display = "block";
    fade4.style.display = "block";
}
// fim do codigo - modal de dica
